...
\section{Skills Summary}
	\resumeSubHeadingListStart
		\resumeSubItem{Languages}{~~~~~~Python, SQL, HTML, CSS, Java, PHP}
		\resumeSubItem{Tools}{~~~~~~~~~~~~~~ChatGPT, GitHub}
...
\section{Work Experience}
	\resumeSubHeadingListStart
		...
		\vspace{5pt}
		\resumeSubheading{BlueCapPro}{Dubai, UAE} {Web Design/Development Intern}{April 2023 - November 2023}
		\resumeItemListStart
			\resumeItemWithoutTitle{\textbf{UI Design Skills:} Honed UI design skills using Figma to create visually appealing website designs.}
			\resumeItemWithoutTitle{\textbf{Website Development:} Developed and customized websites using WordPress and other web builders, with coding experience in HTML, CSS and PHP}
			\resumeItemWithoutTitle{\textbf{SEO Optimization:}Created SEO-optimized content to enhance online visibility.}
		\resumeItemListEnd
		\vspace{5pt}
...
\section{Projects}
	\resumeSubHeadingListStart
		\resumeSubItem{Medical Appointment System}{Developed a fully functional Medical Appointment System.}
		%  \textbf{Tech:} HTML, CSS, PHP, JS and MySQL (April 2023) $\vert$ \href{https://github.com/cr2007/whatsapp-voice-ai-assistant}{\textbf{Project Link}}}
		% \vspace{2pt}
		\resumeSubItem{Library Management System}{Developed a fully functional book website, integrating three databases into a unified system uaing XML}
		%  \textbf{Tech:} HTML, CSS, JS and MySQL (Dec 2023) $\vert$ \href{https://github.com/cr2007/cambai}{\textbf{Project Link}} $\vert$ \href{https://pypi.org/project/cambai}{\textbf{PyPI Link}}}
		% \vspace{2pt}
