...
\section{Work Experience}
	\resumeSubHeadingListStart
		...
		\resumeItemListStart
			\resumeItemWithoutTitle{Designed and implemented RESTful APIs for customer-facing dashboards, increasing service delivery efficiency by 30\%}
			\resumeItemWithoutTitle{Developed a distributed backend system using Spring Boot, ensuring high availability and scalability}
		\resumeItemListEnd
		\vspace{5pt}
