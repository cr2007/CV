...
\section{Projects}
	\resumeSubHeadingListStart
		...
		\vspace{2pt}
		\resumeSubItem{Digital Forensics Investigation}{Performed forensic imaging, analysis, and reporting on digital evidence using industry-standard tools and techniques. (March 2024)}
		\vspace{2pt}
