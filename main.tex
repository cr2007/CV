...
\section{Work Experience}
  \resumeSubHeadingListStart
	...
	\resumeItemListStart
		\resumeItemWithoutTitle{Developed and implemented an updated organizational structure for the company, including job titles and reporting structure for each employee}
		\resumeItemWithoutTitle{Coordinated with the development team to implement the company’s Sales CRM platform, from master data templates to report templates}
		\resumeItemWithoutTitle{Trained and supported employees on the new CRM system provided by the implementation team}
	\resumeItemListEnd
  \resumeSubHeadingListEnd
