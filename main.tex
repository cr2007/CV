...
\section{Skills Summary}
	\resumeSubHeadingListStart
		...
		\resumeSubItem{Tools}{~~~~~~~~~~~~~~Git, GitHub, Bitbucket, Ollama, ChatGPT, CI/CD, Docker, Kubernetes, GitHub Actions, Puppet}
...
\section{Work Experience}
	\resumeSubHeadingListStart
		...
		\resumeItemListStart
			...
			\resumeItemWithoutTitle{Designing and implementing RESTful APIs for customer-facing dashboards, increasing service delivery efficiency by 30\%}
			\resumeItemWithoutTitle{Developing scalable Spring Boot microservices to support secure, reactive APIs for multi-module backend systems}
		\resumeItemListEnd
		\vspace{5pt}
...
\section{Projects}
	\resumeSubHeadingListStart
		\resumeSubItem{Wordle MCP Server}{A Model Context Protocol Server for interacting with the Wordle API for fetching Wordle solutions on a particular date. \textbf{Tech:} uv, Python, FastMCP, MCP (June 2025) $\vert$ \href{https://github.com/cr2007/mcp-wordle-python}{\textbf{Python Project Link}} $\vert$ \href{https://github.com/cr2007/mcp-wordle-go}{\textbf{Go Project Link}}}
		\resumeSubItem{AI Chat Heatmap}{Developed a web app that transforms ChatGPT conversation data into interactive heatmap visualizations with client-side processing for privacy. \textbf{Tech:} TypeScript, Bun (January 2025) $\vert$ \href{https://aiheatmap.csk.fyi/}{\textbf{Live Project}} $\vert$ \href{https://github.com/cr2007/chatgpt-heatmap-web}{\textbf{Project Link}}}
		\vspace{2pt}
